...
When we try to reverse it anyway, it throws an exception. We then catch the exception
and print its 'message', which is s.split is not a function. Next, we finally print 's' which,
...
function reverseString(s) {
  try {
    ...
    const updatedStr = reverseArr.join('');
